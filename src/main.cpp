...
#include <vector>
#include <memory>
#include "GLViewShardsOfGranius.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewShardsOfGranius > glView( Aftr::GLViewShardsOfGranius::New( args ) );
